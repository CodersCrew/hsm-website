...
export const Header = () => (
  <section className="relative mx-auto max-h-[961px] max-w-[1440px]">
    ...
    <div className="justify-end from-black/70 via-black/20 to-black/0 px-4 md:absolute md:bottom-[0] md:flex md:h-full md:w-full md:flex-col md:bg-gradient-to-t md:text-neutral/20 lg:px-14 xl:px-[120px]">
      <h1 className="my-6 text-[28px] font-semibold text-neutral/90 md:text-[44px] md:text-4xl md:text-neutral/20">
        Humanizacja Środowiska Miejskiego
      </h1>
      <p className="text-base leading-7 lg:text-[18px] lg:tracking-widest">
        Koło Naukowe zostało złożone w 2007 roku przez prof. Zbigniewa Bacia – opiekuna Koła i Jerzego Łątkę- studenta
        Wydziału Architektury.
      </p>
      <p className="mb-12 text-base font-normal leading-7 lg:text-[18px] lg:tracking-widest">
