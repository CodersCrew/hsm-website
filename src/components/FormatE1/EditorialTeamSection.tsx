        ...
        <div className="bg-neutral/20 py-8 px-4">
          <div className="space-y-4 md:max-w-2xl lg:space-y-8">
            ...
            <p>
              ...
              dzielić się z szerszą publicznością. Dzięki motywom przewodnim, tematyka zawarta w poszczególnych
              wydaniach jest różnorodna. Zgłębiane są zarówno dziedziny architektury i urbanistyki, jak również sztuki,
              budownictwa czy designu.
            </p>
            <p>
              Skupiamy się nie tylko na studentach z Politechniki Wrocławskiej, ale też osobach z innych uczelni
              wyższych w Polsce i zza granicy.
            </p>
          </div>
