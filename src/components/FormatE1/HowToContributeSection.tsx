...
export const HowToContributeSection = () => (
  <div className="mx-auto max-w-screen-xl bg-neutral/20 py-8 px-4 lg:flex lg:bg-neutral/10 lg:py-16">
    <div>
      ...
      <p>
        Zarówno teksty, projekty, jak i materiały graficzne może przysłać do nas każdy student, niezależnie od tego, czy
        jest związany z Politechniką Wrocławską czy nie :)
      </p>
    </div>
    <div className="mx-auto mt-12 max-w-screen-sm">
      <div className="my-2 flex items-center justify-center">
        <Image src={NumberedIcon1} width={35} height={35} alt="numbered icon" />
        <p className="ml-4">Wybór tematu związanego z motywem przewodnim; zgłoszenie pracy redakcji czasopisma.</p>
      </div>
      <div className="my-2 flex items-center justify-center">
